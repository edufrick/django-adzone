...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        ...
        AdBase = orm["adzone.adbase"]
        ads_enabled = AdBase.objects.filter(
            start_showing__lte=now(), stop_showing__gte=now()
        )
        ads_enabled.update(enabled=True)
        ads_disabled = AdBase.objects.filter(
            start_showing__gte=now()
    ...
    models = {
        "adzone.adbase": {
            ...
            "advertiser": (
                ...
                [],
                {"to": "orm['adzone.Advertiser']"},
            ),
            "category": (
                "django.db.models.fields.related.ForeignKey",
                [],
                {"to": "orm['adzone.AdCategory']"},
            ),
            "enabled": (
            ...
            "stop_showing": (
                "django.db.models.fields.DateTimeField",
                [],
                {"default": "datetime.datetime(9999, 12, 29, 0, 0)"},
            ),
        ...
        "adzone.bannerad": {
            ...
            "adbase_ptr": (
                ...
                [],
                {"to": "orm['adzone.AdBase']", "unique": "True", "primary_key": "True"},
            ),
            "content": (
